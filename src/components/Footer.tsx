...
import { Instagram, Mail, Phone, MapPin, Facebook, Linkedin } from 'lucide-react';
...
export const Footer = () => {
  ...
  useEffect(() => {
    const ADMIN_CLICK_THRESHOLD = 7;

    if (logoClickCount >= ADMIN_CLICK_THRESHOLD) {
        ...
        <div className="grid md:grid-cols-4 gap-6 md:gap-8 lg:gap-12 mb-8 md:mb-12 lg:mb-16">
          <div>
            <img 
              ...
              className="h-12 md:h-16 lg:h-20 mb-3 md:mb-4 lg:mb-6 cursor-pointer"
